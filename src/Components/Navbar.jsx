...
const Navbar = () => {
  ...
  return (
    <nav className='bg-indigo-800 p-4 flex justify-between ml-64'>
      ...
      <div className='flex items-center gap-x-5'>
        <div className='relative md:w-65'>
            <span className='relative md:absolute inset-y-0 left-0 flex pl-2 items-center'>
                <button className='p-1 focus:outline-none text-white md:text-black'><FaSearch className=''/></button></span>
            <input type="text" className='w-full bg-white outline-none px-4 py-1 pl-12 rounded shadow hidden md:block'/>
        </div>
</div>
         {/* Right Section */}
